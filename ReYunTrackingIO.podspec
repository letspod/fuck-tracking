Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.requires_arc = true
  s.source        = {"http": "https://sdk.s3.cn-north-1.amazonaws.com.cn/new_trackingIO/trackingIO_iOS_1.9.8.zip"}
  ...
  s.source_files  = 'trackingIO_iOS_1.9.8/*.{h}'
  s.public_header_files = "trackingIO_iOS_1.9.8/*.h"
  s.vendored_libraries = 'trackingIO_iOS_1.9.8/libReYunTracking.a'
