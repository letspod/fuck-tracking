...
//
#define REYUN_TRACKING_VERSION @"1.9.11"
...
//是否开启MobDNA防作弊，主动调用传入false关闭，默认开启(在initWithAppKey:withChannelId:前调用)
...
/// @param oid MobDNA 防作弊功能需要参数(热云组织标识符)  没有相关需求可为空 传入 nil
